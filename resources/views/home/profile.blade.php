                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form>
                                        ...
                                        <div class="form-group row">
                                            <label for="text" class="col-md-4 col-form-label">Nick Name*</label>
                                            <div class="col-8">
                                                <input id="text" name="text" placeholder="Nick Name" class="form-control here" required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="select" class="col-md-4 col-form-label">Display Name public as</label>
                                            <div class="col-8">
                                        ...
                                        <div class="form-group row">
                                            <label for="publicinfo" class="col-md-4 col-form-label">Public Info</label>
                                            <div class="col-8">
